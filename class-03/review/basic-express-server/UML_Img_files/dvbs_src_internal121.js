...
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(h,w,t){h!=Array.prototype&&h!=Object.prototype&&(h[w]=t.value)};$jscomp.getGlobal=function(h){return"undefined"!=typeof window&&window===h?h:"undefined"!=typeof global&&null!=global?global:h};$jscomp.global=$jscomp.getGlobal(this);$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
$jscomp.iteratorPrototype=function(h){$jscomp.initSymbolIterator();h={next:h};h[$jscomp.global.Symbol.iterator]=function(){return this};return h};$jscomp.iteratorFromArray=function(h,w){$jscomp.initSymbolIterator();h instanceof String&&(h+="");var t=0,p={next:function(){if(t<h.length){var C=t++;return{value:w(C,h[C]),done:!1}}p.next=function(){return{done:!0,value:void 0}};return p.next()}};p[Symbol.iterator]=function(){return p};return p};
$jscomp.polyfill=function(h,w,t,p){if(w){t=$jscomp.global;h=h.split(".");for(p=0;p<h.length-1;p++){var C=h[p];C in t||(t[C]={});t=t[C]}h=h[h.length-1];p=t[h];w=w(p);w!=p&&null!=w&&$jscomp.defineProperty(t,h,{configurable:!0,writable:!0,value:w})}};$jscomp.polyfill("Array.prototype.keys",function(h){return h?h:function(){return $jscomp.iteratorFromArray(this,function(h){return h})}},"es6","es3");
function dv_baseHandler(){function h(b){var c=window._dv_win,f=0;try{for(;10>f;){if(c[b]&&"object"===typeof c[b])return!0;if(c==c.parent)break;f++;c=c.parent}}catch(e){}return!1}function w(b){var c=0,f;for(f in b)b.hasOwnProperty(f)&&++c;return c}function t(b,c){a:{var f={};try{if(b&&b.performance&&b.performance.getEntries){var e=b.performance.getEntries();for(b=0;b<e.length;b++){var d=e[b],x=d.name.match(/.*\/(.+?)\./);if(x&&x[1]){var g=x[1].replace(/\d+$/,""),k=c[g];if(k){for(var h=0;h<k.stats.length;h++){var q=
k.stats[h];f[k.prefix+q.prefix]=Math.round(d[q.name])}delete c[g];if(!w(c))break}}}}var m=f;break a}catch(D){}m=void 0}if(m&&w(m))return m}function p(b,c){function f(b){var d=q,c;for(c in b)b.hasOwnProperty(c)&&(d+=["&"+c,"="+b[c]].join(""));return d}function e(){return Date.now?Date.now():(new Date).getTime()}function d(){if(!w){w=!0;var d=f({dvp_injd:1});$dvbs.domUtilities.addImage(d,document.body);d="https://cdn.doubleverify.com/dvtp_src.js#tagtype=video";var c="ctx cmp plc sid adsrv adid crt advid prr dup turl iframe ad vssd apifw vstvr tvcp ppid auip pltfrm gdpr gdpr_consent adu invs litm ord sadv scrt vidreg seltag splc spos sup unit dvtagver msrapi vfwctx auprice audeal auevent auadv aucmp aucrtv auorder ausite auplc auxch audvc aulitem auadid autt c1 c2 c3 c4 c5 c6 c7 c8 c9 c10 c11 c12 c13 c14 c15 aufilter1 aufilter2 ppid".split(" ");
for(i=0;i<c.length;i++){var g=c[i],x=k(b,g);void 0!==x&&(d+=["&",g,"=",encodeURIComponent(x)].join(""))}d+="&gmnpo="+("1"==b.gmnpo?"1":"0");d+="&dvp_dvtpts="+e();d+="&bsimpid="+h;void 0!==b.dvp_aubndl&&(d+="&aubndl="+encodeURIComponent(b.dvp_aubndl));for(var m in b)b.hasOwnProperty(m)&&m.match(/^dvpx?_/i)&&b[m]&&(d+=["&",m.toLocaleLowerCase(),"=",encodeURIComponent(b[m])].join(""));$dvbs.domUtilities.addScriptResource(d,document.body)}}function x(b){var d={};d[b]=e();b=f(d);$dvbs.domUtilities.addImage(b,
document.body)}function g(b,d){-1<u.indexOf(b)?x(d):t.subscribe(function(){x(d)},b)}function k(b,d){d=d.toLowerCase();for(tmpKey in b)if(tmpKey.toLowerCase()===d)return b[tmpKey];return null}var h=b.impressionId,q=window._dv_win.dv_config.bsEventJSURL?window._dv_win.dv_config.bsEventJSURL:"https://"+b.ServerPublicDns+"/bsevent.gif";q+="?flvr=0&impid="+encodeURIComponent(h);var m=f({dvp_innovidImp:1}),D="responseReceived_"+h,v=b.DVP_DCB||b.DVP_DECISION_CALLBACK,n=k(b,"adid"),r=function(b){var d=b;
switch(b){case 5:d=1;break;case 6:d=2}return d}(c.ResultID),w=!1;$dvbs.domUtilities.addImage(m,document.body);if("function"===typeof window[v]){var y=!1;setTimeout(function(){var b=f({dvp_wasCallbackCalled:y});$dvbs.domUtilities.addImage(b,document.body)},1E3);window[D]=function(b,c,g,x,k,m,n){y=!0;try{if(n){var l=f({dvp_stat:n});$dvbs.domUtilities.addImage(l,document.body)}else{l=f({dvp_r9:e()});$dvbs.domUtilities.addImage(l,document.body);g="&dvp_cStartTS="+g+"&dvp_cEndTS="+x+"&dvp_dReceivedTS="+
k+"&dvp_wasAdPlayed="+b;x=r;if(!c)switch(x=2,r){case 1:var h=21;break;case 2:h=20;break;case 3:h=22;break;case 4:h=23}c={bres:x,dvp_blkDecUsed:c?"1":"0"};h&&(c.breason=h);l=f(c)+g;$dvbs.domUtilities.addImage(l,document.body,m);b&&!checkIsOvv()&&d()}}catch(N){b=f({dvp_innovidCallbackEx:1,dvp_innovidCallbackExMsg:N}),$dvbs.domUtilities.addImage(b,document.body)}};try{var p=f({dvp_r8:e()});$dvbs.domUtilities.addImage(p,document.body);window[v](r,D)}catch(z){c=f({dvp_innovidEx:1,dvp_innovidExMsg:z}),
$dvbs.domUtilities.addImage(c,document.body)}}else c=f({dvp_innovidNoCallback:1}),$dvbs.domUtilities.addImage(c,document.body);try{var t=window[n]();if(t.getPreviousEvents&&"function"===typeof t.getPreviousEvents){p=f({dvp_r10:e()});$dvbs.domUtilities.addImage(p,document.body);var u=t.getPreviousEvents(),l=0;-1<u.indexOf("AdStarted")?(l=1,d()):t.subscribe(d,"AdStarted");p=f({dvp_innovidAdStarted:l,dvp_innovidPrevEvents:u});$dvbs.domUtilities.addImage(p,document.body);g("AdError","dvp_ader");g("AdStopped",
"dvp_adst");g("AdVideoStart","dvp_avse");g("AdImpression","dvp_aie")}else l=f({dvp_innovidCallbackEx:3,dvp_innovidCallbackExMsg:"vpaidWrapper.getPreviousEvents not a function"}),$dvbs.domUtilities.addImage(l,document.body)}catch(z){l=f({dvp_innovidCallbackEx:2,dvp_innovidCallbackExMsg:z,dvp_adid:n}),$dvbs.domUtilities.addImage(l,document.body)}}function C(b,c){try{$dvbs.registerEventCall(b,{dvp_te_exec:O.RTN}),Object.keys(c).length&&c.forEach(function(c){c.actions&&c.actions.length?c.actions.forEach(function(e){$dvbs.pubSub.subscribe(c.eventName,
...
typeof window._dv_win.document.msHidden?d="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(d="webkitvisibilitychange");window._dv_win.document.addEventListener(d,b,!1)}}());if("1"!=b.foie)try{var x=t(window,{verify:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});x&&window._dv_win.$dvbs.registerEventCall(e.ImpressionID,x)}catch(g){}};window[b.callbackName]=function(e){A.setIsJSONPCalled(!0);var d=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[c]?
...
f=b.innerHTML.replace(e,"\x3c/script>");b=d(b);b.hasPassback=!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:c,tagPassback:f}};return d(b)}function J(b,c,f,e,d,x,g,k,w,q,m,D){c.dvregion=0;var v=dv_GetParam(l,"useragent");l=window._dv_win.$dvbs.CommonData;if(void 0!=l.BrowserId&&void 0!=l.BrowserVersion&&void 0!=l.BrowserIdFromUserAgent)var n={ID:l.BrowserId,version:l.BrowserVersion,ID_UA:l.BrowserIdFromUserAgent};else n=R(v?decodeURIComponent(v):navigator.userAgent),l.BrowserId=n.ID,l.BrowserVersion=
n.version,l.BrowserIdFromUserAgent=n.ID_UA;var r="";void 0!=c.aUrl&&(r="&aUrl="+c.aUrl);var p="";try{e.depth=S(e);var y=T(e,f,n);if(y&&y.duration){var t="&dvp_strhd="+y.duration;t+="&dvpx_strhd="+y.duration}y&&y.url||(y=U(e));y&&y.url&&(r="&aUrl="+encodeURIComponent(y.url),p="&aUrlD="+y.depth);var E=e.depth+d;x&&e.depth--}catch(I){t=p=r=E=e.depth=""}a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var u=1;break a}}catch(I){}u=0}d=function(){function b(d){c++;var e=d.parent==
d;return d.mraid||e?d.mraid:20>=c&&b(d.parent)}var d=window._dv_win||window,c=0;try{return b(d)}catch(ea){}}();var l=c.script.src;u="&ctx="+(dv_GetParam(l,"ctx")||"")+"&cmp="+(dv_GetParam(l,"cmp")||"")+"&plc="+(dv_GetParam(l,"plc")||"")+"&sid="+(dv_GetParam(l,"sid")||"")+"&advid="+(dv_GetParam(l,"advid")||"")+"&adsrv="+(dv_GetParam(l,"adsrv")||"")+"&unit="+(dv_GetParam(l,"unit")||"")+"&isdvvid="+(dv_GetParam(l,"isdvvid")||"")+"&uid="+c.uid+"&tagtype="+(dv_GetParam(l,"tagtype")||"")+"&adID="+(dv_GetParam(l,
"adID")||"")+"&app="+(dv_GetParam(l,"app")||"")+"&sup="+(dv_GetParam(l,"sup")||"")+"&isovv="+u+"&gmnpo="+(dv_GetParam(l,"gmnpo")||"")+"&crt="+(dv_GetParam(l,"crt")||"");"1"==dv_GetParam(l,"foie")&&(u+="&foie=1");d&&(u+="&ismraid=1");(d=dv_GetParam(l,"xff"))&&(u+="&xff="+d);(d=dv_GetParam(l,"vssd"))&&(u+="&vssd="+d);(d=dv_GetParam(l,"apifw"))&&(u+="&apifw="+d);(d=dv_GetParam(l,"vstvr"))&&(u+="&vstvr="+d);(d=dv_GetParam(l,"tvcp"))&&(u+="&tvcp="+d);m&&(u+="&urlsrc=sf");D&&(u+="&sfe=1");navigator&&navigator.maxTouchPoints&&
5==navigator.maxTouchPoints&&(u+="&touch=1");navigator&&navigator.platform&&(u+="&nav_pltfrm="+navigator.platform);t&&(u+=t);v&&(u+="&useragent="+v);n&&(u+="&brid="+n.ID+"&brver="+n.version+"&bridua="+n.ID_UA);u+="&dup="+dv_GetParam(l,"dup");try{u+=dv_AppendIQPAParams(l)}catch(I){}(m=dv_GetParam(l,"turl"))&&(u+="&turl="+m);(m=dv_GetParam(l,"tagformat"))&&(u+="&tagformat="+m);"video"===dv_GetParam(l,"tagtype")&&(u+="&DVP_BYPASS219=1");u+=V();q=q?"&dvf=0":"";m=h("maple")?"&dvf=1":"";g=(window._dv_win.dv_config.verifyJSURL||
"https://"+(window._dv_win.dv_config.bsAddress||"rtb"+c.dvregion+".doubleverify.com")+"/verify.js")+"?flvr=0&jsCallback="+c.callbackName+"&jsTagObjCallback="+c.tagObjectCallbackName+"&num=6"+u+"&srcurlD="+e.depth+"&ssl="+c.ssl+q+m+"&refD="+E+c.tagIntegrityFlag+c.tagHasPassbackFlag+"&htmlmsging="+(g?"1":"0")+"&tstype="+K(window._dv_win);(E=dv_GetDynamicParams(l,"dvp").join("&"))&&(g+="&"+E);(E=dv_GetDynamicParams(l,"dvpx").join("&"))&&(g+="&"+E);if(!1===k||w)g=g+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+
("&dvp_isOnHead="+(w?"1":"0"));f="srcurl="+encodeURIComponent(f);(k=W())&&(f+="&ancChain="+encodeURIComponent(k));(e=X(e))&&(f+="&canurl"+encodeURIComponent(e));e=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(e=2E3);if(k=dv_GetParam(l,"referrer"))k="&referrer="+k,g.length+k.length<=e&&(g+=k);(k=dv_GetParam(l,"prr"))&&(g+="&prr="+k);(k=dv_GetParam(l,"iframe"))&&(g+="&iframe="+k);(k=dv_GetParam(l,"gdpr"))&&(g+="&gdpr="+k);(k=dv_GetParam(l,"gdpr_consent"))&&(g+="&gdpr_consent="+
k);r.length+p.length+g.length<=e&&(g+=p,f+=r);(r=Y())&&(g+="&m1="+r);(r=Z())&&0<r.f&&(g+="&bsig="+r.f,g+="&usig="+r.s);r=aa();0<r&&(g+="&hdsig="+r);navigator&&navigator.hardwareConcurrency&&(g+="&noc="+navigator.hardwareConcurrency);g+=ba();r=ca();g+="&vavbkt="+r.vdcd;g+="&lvvn="+r.vdcv;""!=r.err&&(g+="&dvp_idcerr="+encodeURIComponent(r.err));"prerender"===window._dv_win.document.visibilityState&&(g+="&prndr=1");(l=dv_GetParam(l,"wrapperurl"))&&1E3>=l.length&&g.length+l.length<=e&&(g+="&wrapperurl="+
l);g+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(F(f));g=g.length+b.length<=e?g+b:g+"&dvf=3";window.performance&&window.performance.mark&&window.performance.measure&&window.performance.getEntriesByName&&(window.performance.mark("dv_create_req_end"),window.performance.measure("dv_creqte_req","dv_create_req_start","dv_create_req_end"),(b=window.performance.getEntriesByName("dv_creqte_req"))&&0<b.length&&(g+="&dvp_exetime="+b[0].duration.toFixed(2)));for(var z in c)c.hasOwnProperty(z)&&
void 0!==c[z]&&-1<["number","string"].indexOf(typeof c[z])&&-1===["protocol","callbackName","dvregion"].indexOf(z.toLowerCase())&&!z.match(/^tag[A-Z]/)&&!(new RegExp("(\\?|&)"+z+"=","gi")).test(g)&&(g+=["&",z,"=",encodeURIComponent(c[z])].join(""));return{isSev1:!1,url:g}}function V(){var b="";try{var c=window._dv_win.parent;b+="&chro="+(void 0===c.chrome?"0":"1");b+="&hist="+(c.history?c.history.length:"");b+="&winh="+c.innerHeight;b+="&winw="+c.innerWidth;b+="&wouh="+c.outerHeight;b+="&wouw="+c.outerWidth;
c.screen&&(b+="&scah="+c.screen.availHeight,b+="&scaw="+c.screen.availWidth)}catch(f){}return b}function ca(){var b=[],c=function(b){e(b,null!=b.AZSD,9);e(b,b.location.hostname!=b.encodeURIComponent(b.location.hostname),10);e(b,null!=b.cascadeWindowInfo,11);e(b,null!=b._rvz,32);e(b,null!=b.FO_DOMAIN,34);e(b,null!=b.va_subid,36);e(b,b._GPL&&b._GPL.baseCDN,40);e(b,f(b,"__twb__")&&f(b,"__twb_cb_"),43);e(b,null!=b.landingUrl&&null!=b.seList&&null!=b.parkingPPCTitleElements&&null!=b.allocation,45);e(b,
f(b,"_rvz",function(b){return null!=b.publisher_subid}),46);e(b,null!=b.cacildsFunc&&null!=b.n_storesFromFs,47);e(b,b._pcg&&b._pcg.GN_UniqueId,54);e(b,f(b,"__ad_rns_")&&f(b,"_$_"),64);e(b,null!=b.APP_LABEL_NAME_FULL_UC,71);e(b,null!=b._priam_adblock,81);e(b,b.supp_ads_host&&b.supp_ads_host_overridden,82);e(b,b.uti_xdmsg_manager&&b.uti_xdmsg_manager.cb,87);e(b,b.LogBundleData&&b.addIframe,91);e(b,b.xAdsXMLHelperId||b.xYKAffSubIdTag,95);e(b,b.__pmetag&&b.__pmetag.uid,98);e(b,b.CustomWLAdServer&&/(n\d{1,4}adserv)|(1ads|cccpmo|epommarket|epmads|adshost1)/.test(b.supp_ads_host_overridden),
...
try{for(var c=0;window._dv_win.top!=b&&10>=c;){var f=b.parent;if(!f.document)break;b=f;c++}}catch(e){}return b==window._dv_win.top?$dvbs.Enums.TrafficScenario.SameDomain:$dvbs.Enums.TrafficScenario.CrossDomain}function T(b,c,f){try{if(f.ID==$dvbs.Enums.BrowserId.IE||K(b)!=$dvbs.Enums.TrafficScenario.CrossDomain)return null;b.performance&&b.performance.mark&&b.performance.mark("dv_str_html_start");if(c){var e=c.toString().match(/^(?:https?:\/\/)?[\w\-\.]+\/[a-zA-Z0-9]/gi);if(e&&0<e.length)return null}var d=
b.document;if(d&&d.referrer){var h=d.referrer.replace(/\//g,"\\/").replace(/\./g,"\\."),g=new RegExp('(?:w{0,4}=")?'+h+"[^&\"; %,'\\$\\\\\\|]+","gi");c=/banner|adprefs|safeframe|sandbox|sf\.html/gi;f=/^\w{0,4}="/gi;var k=L(d,"script","src",g,c,f);if(!k){var p=d.referrer;e="";var q=d.getElementsByTagName("script");if(q)for(h=0;!e&&h<q.length;){var m=q[h].innerHTML;if(m&&-1!=m.indexOf(p)){var D=m.match(g);e=M(D,c,f)}h++}(k=e)||(k=L(d,"a","href",g,c,f))}d=htmlUrl=k;a:{if(b.performance&&b.performance.mark&&
b.performance.measure&&b.performance.getEntriesByName){b.performance.mark("dv_str_html_end");b.performance.measure("dv_str_html","dv_str_html_start","dv_str_html_end");var v=b.performance.getEntriesByName("dv_str_html");if(v&&0<v.length){var n=v[0].duration.toFixed(2);break a}}n=null}return{url:d,depth:-1,duration:n}}}catch(r){}return null}function M(b,c,f){var e="";if(b&&0<b.length)for(var d=0;d<b.length;d++){var h=b[d];h.length>e.length&&null==h.match(c)&&0!=h.indexOf('src="')&&0!=h.indexOf('turl="')&&
(e=h.replace(f,""))}return e}function L(b,c,f,e,d,h){b=b.querySelectorAll(c+"["+f+'*="'+b.referrer+'"]');var g="";if(b)for(c=0;!g&&c<b.length;)g=b[c][f].match(e),g=M(g,d,h),c++;return g}function U(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var f,e=1,d=0;0<e&&100>d;){try{if(d++,f=c.shift(),e--,0<f.win.location.toString().length&&f.win!=b)return 0==f.win.document.referrer.length||0==f.depth?{url:f.win.location,depth:f.depth}:{url:f.win.document.referrer,
depth:f.depth-1}}catch(k){}var h=f.win.frames.length;for(var g=0;g<h;g++)c.push({win:f.win.frames[g],depth:f.depth+1}),e++}return{url:"",depth:""}}catch(k){return{url:"",depth:""}}}function W(){var b=window._dv_win[F("=@42E:@?")][F("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var f=0;f<b.length;f++)c[f+1]=b[f];return c.reverse().join(",")}return null}function X(b){return(b=b.document.querySelector("link[rel=canonical]"))?
b.href:null}function F(b){new String;var c=new String,f;for(f=0;f<b.length;f++){var e=b.charAt(f);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(e);0<=d&&(e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));c+=e}return c}function G(){return Math.floor(1E12*(Math.random()+""))}function R(b){for(var c=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",
...
arguments)}},e="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):e?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},h=["Moz","O","ms","Webkit"],g=["moz","o","ms","webkit"],k={style:d("modernizr").style},p=function(b,c){function e(){g&&(delete k.style,delete k.modElem)}var f;for(f=["modernizr","tspan","samp"];!k.style&&
f.length;){var g=!0;k.modElem=d(f.shift());k.style=k.modElem.style}var h=b.length;for(f=0;f<h;f++){var m=b[f];~(""+m).indexOf("-")&&(m=cssToDOM(m));if(void 0!==k.style[m])return e(),"pfx"==c?m:!0}e();return!1},q=function(b,c,d){var e=b.charAt(0).toUpperCase()+b.slice(1),k=(b+" "+h.join(e+" ")+e).split(" ");if("string"===typeof c||"undefined"===typeof c)return p(k,c);k=(b+" "+g.join(e+" ")+e).split(" ");for(var m in k)if(k[m]in c){if(!1===d)return k[m];b=c[k[m]];return"function"===typeof b?f(b,d||
c):b}return!1};c(0,!0);c(1,q("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,q("shapeOutside","content-box",!0));return b}catch(m){return 0}}function H(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(f){}return b}function Z(){try{var b=H(),c=0,f=0,e=function(b,d,e){e&&(c+=Math.pow(2,b),f+=Math.pow(2,d))},d=b.document;e(14,0,b.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));e(14,1,(b.CustomWLAdServer||
...
c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,f++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(r){b=!1}a:{try{var h=c.$sf;break a}catch(r){}h=void 0}var g=(d=c.location&&c.location.ancestorOrigins)&&d[d.length-1];if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;a:{try{var k=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(r){}k=void 0}if(k&&(!d||0==k.indexOf(g))){b=k;var p=!0}e=!0}if(!window._dv_win.dvbsScriptsInternal||
!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};d=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();k=d.script;this.dv_script_obj=d;this.dv_script=k;window._dv_win.dvbsProcessed.push(d);window._dv_win._dvScripts.push(k);g=k.src;this.dvOther=0;this.dvStep=1;var q=window._dv_win.dv_config?window._dv_win.dv_config.dv_GetRnd?
window._dv_win.dv_config.dv_GetRnd():G():G();d=window.parent.postMessage&&window.JSON;var m={};try{for(var t=/[\?&]([^&]*)=([^&#]*)/gi,v=t.exec(g);null!=v;)"eparams"!==v[1]&&(m[v[1]]=v[2]),v=t.exec(g);var n=m}catch(r){n=m}this.tagParamsObj=n;n.perf=this.perf;n.uid=q;n.script=this.dv_script;n.callbackName="__verify_callback_"+n.uid;n.tagObjectCallbackName="__tagObject_callback_"+n.uid;n.tagAdtag=null;n.tagPassback=null;n.tagIntegrityFlag="";n.tagHasPassbackFlag="";0==(null!=n.tagformat&&"2"==n.tagformat)&&
(v=Q(n.script),n.tagAdtag=v.tagAdTag,n.tagPassback=v.tagPassback,v.isBadImp?n.tagIntegrityFlag="&isbadimp=1":v.hasPassback&&(n.tagHasPassbackFlag="&tagpb=1"));v=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream;n.protocol="https:";n.ssl="1";g=n;(q=window._dv_win.dvRecoveryObj)?("2"!=g.tagformat&&(q=q[g.ctx]?q[g.ctx].RecoveryTagID:q._fallback_?q._fallback_.RecoveryTagID:1,
1===q&&g.tagAdtag?document.write(g.tagAdtag):2===q&&g.tagPassback&&document.write(g.tagPassback)),g=!0):g=!1;if(g)return{isSev1:!0};this.dvStep=2;P(n);k=k&&k.parentElement&&k.parentElement.tagName&&"HEAD"===k.parentElement.tagName;this.dvStep=3;return J(this,n,b,c,f,e,d,!0,k,v,p,h)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");if(A)try{A.setVersionData(this.getVersionParamName(),this.getVersion()),c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body,A.onLoad,A.onError,A.uniqueKey):
dv_sendScriptRequest(b,A.onLoad,A.onError,A.uniqueKey)}catch(f){c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b)}else c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};var O={RTN:1};window.debugScript&&(window.CreateUrl=J);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"168"}};
