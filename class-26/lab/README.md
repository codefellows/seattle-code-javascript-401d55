...
1. Use [Vite](https://vitejs.dev/guide/) to create a new React application named `resty`.
...
> Consider leveraging a chatbot to check your work.  Copy one of the original class components from the starter code. Does the prompt `refactor the following React class component into a React function component` work when you feed it that original class component?  What differences do you notice? 
